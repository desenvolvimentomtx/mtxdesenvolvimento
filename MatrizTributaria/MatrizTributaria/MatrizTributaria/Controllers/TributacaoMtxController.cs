            ...
            if (ncm != "")
            {
                ...
                if (tribNCM.Count > 0)
                {
                    ...
                    for (int i = 0; i < qtd; i++)
                    {
                        ...
                        db.TributacoesNcm.Remove(tribDel); //remove caso tenha
                        db.SaveChanges();
                    }
        ...
        public EmptyResult VerificaTempDataNCM(string regime, string crt)
        {
            ...
            if (TempData["tributacao_MTX_NCMView"] == null)
            {
              ...
              this.tributacaoMTX_NCMView = from a in db.TributacoesNcmView where a.CRT == crtTrib && a.REGIME_TRIBUTARIO == regimeTrib select a; //FILTRA O QUE FOR SIMPLES NACIONAL
                ...
                //    {
                //    case "1":
                //        this.tributacaoMTX_NCMView = from a in db.TributacoesNcmView where a.CRT == 1 select a; //FILTRA O QUE FOR SIMPLES NACIONAL
                //        break;
                //    case "2":
                //        this.tributacaoMTX_NCMView = from a in db.TributacoesNcmView where a.CRT == 2 select a; //FILTRA O QUE FOR SIMPLES NACIONALb
                //        break;
                //    case "3":
                //        this.tributacaoMTX_NCMView = from a in db.TributacoesNcmView where a.CRT == 3 select a; //FILTRA O QUE FOR SIMPLES NACIONALb
                //        break;
                //    case "4":
                //        this.tributacaoMTX_NCMView = from a in db.TributacoesNcmView where a.CRT == 4 select a; //FILTRA O QUE FOR SIMPLES NACIONALb
                //        break;
                ...
                //{
                //    case "1":
                //        this.tributacaoMTX_NCMView = from a in db.TributacoesNcmView where a.REGIME_TRIBUTARIO == 1 select a; //FILTRA O QUE FOR SIMPLES NACIONAL
                //        break;
                //    case "2":
                //        this.tributacaoMTX_NCMView = from a in db.TributacoesNcmView where a.REGIME_TRIBUTARIO == 2 select a; //FILTRA O QUE FOR SIMPLES NACIONALb
                //        break;
                //    case "3":
                //        this.tributacaoMTX_NCMView = from a in db.TributacoesNcmView where a.REGIME_TRIBUTARIO == 3 select a; //FILTRA O QUE FOR SIMPLES NACIONALb
                //        break;
                //    case "4":
                //        this.tributacaoMTX_NCMView = from a in db.TributacoesNcmView where a.REGIME_TRIBUTARIO == 4 select a; //FILTRA O QUE FOR SIMPLES NACIONALb
                //        break;
